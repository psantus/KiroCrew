...
class Backend:
    ...
    async def evict_stub_subscriptions(self, stub_uuid: str) -> int:
        ...
        rekeyed stub. In-flight unsubscribes are left to settle — their
        responses carry no resource content and their table effects are
        already applied or idempotent.
        """
